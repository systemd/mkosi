...
async def test_history_found_via_configured_output_directory(stack: contextlib.AsyncExitStack) -> None:
    tmp_path = tmp_dir(stack)
    d = tmp_path
    ...
    Assert.eq(config.image_id, "img-x")


async def test_history_isolated_per_output_directory(stack: contextlib.AsyncExitStack) -> None:
    tmp_path = tmp_dir(stack)
    d = tmp_path
    ...
    Assert.eq(config_last.image_id, "img-b")
    Assert.eq(config_a.image_id, "img-a")
    Assert.eq(config_b.image_id, "img-b")
