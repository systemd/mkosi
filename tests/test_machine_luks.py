...
pytestmark = [pytest.mark.integration, pytest.mark.skipif(os.getuid() != 0, reason="Must be invoked as root.")]
...
class MkosiLuksWithImageIdMachineTestCase(MkosiMachineTest):
    ...
    def setUpClass(cls) -> None:
        ...
        if (
            cls.machine.args.distribution == Distribution.centos_epel
            and cls.machine.args.verb == Verb.qemu
            and not cls.machine.args.qemu_kvm
        ):
